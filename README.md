...
Narrative direction: you arrive on your land, meet the foreman on-site, and build your house step by step with guidance always nearby.
...
- **Warm Guidance** — The foreman uses beginner-friendly prompts and light small-talk to make the builder feel more welcoming
...
Agent engineering and structure rules are documented in [docs/AGENT_CODE_OF_CONDUCT.md](docs/AGENT_CODE_OF_CONDUCT.md).
This is the repo standard for file structure, modularity, world-state discipline, and verification.
