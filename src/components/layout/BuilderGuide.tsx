...
const BUILD_STEPS: BuildStep[] = [
  {
    id: "foundation",
    label: "1. Add foundation",
    tip: "Start by placing a foundation on the land. This becomes your main build base.",
    tool: "foundation",
    check: (w) => w.foundation !== null,
  },
  {
    id: "pillars",
    label: "2. Place pillars",
